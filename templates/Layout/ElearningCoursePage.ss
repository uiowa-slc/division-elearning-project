<div class="col-md-8">
	<!--<p class="slide-nav">
		<a href="#" class="btn"> <span class="glyphicon glyphicon-volume-up"></span> Play Audio</a> <a class="btn">Next</a>
	</p>-->
	<h1>What is Critical M.A.S.S.?</h1>
	<p><h2>In a nutshell:</h2> 
		<ul>
			<li>a supportive program to connect volunteer staff and faculty members with:
				<ul>
					<li>students found responsible for violating the Code of Student Life</li>
					<li>students who may benefit from mentoring</li>
				</ul>
			</li>
			<li>Create a positive relationship with the student</li>
			<li>Work with the student to motivate positive behavior change </li>
		</ul>
		<h2>Program Goals</h2>
...
<div class="col-md-4">
	<% include ElearningCourseSecondLevelNav %>
</div>